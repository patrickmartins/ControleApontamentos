        ...
        public async Task<IEnumerable<ApontamentoResponse>> ObterApontamentosPorPeriodoAsync(DateOnly inicio, DateOnly fim)
        {
            var stream = await _policy.ExecuteAsync(() =>
            {
                ...
                return _configuracoes.UrlBase
                                    ...
                                    .SetQueryParam("areaColaborador", "null")
                                    .SetQueryParam("dataInicio", inicio.ToString("d"))
                                    .SetQueryParam("dataFim", fim.ToString("d"))
                                    .SetQueryParam("idPrograma", 0)
                                    .SetQueryParam("idProjeto", 0)
                                    .SetQueryParam("idOperacao", 0)
                                    .SetQueryParam("idCliente", 0)
                                    .SetQueryParam("idTicket", 0)
                                    .SetQueryParam("tipoRelatorio", 1)
                                    .SetQueryParam("idColaborador", "null")
                                    .SetQueryParam("idTipoOperacao", 0)
                                    .SetQueryParam("comFilhosAreaColaborador", true)
                                    .SetQueryParam("comFilhosArea", true)
                                    .SetQueryParam("direcaoOrdenacao", "ASC")
                                    .SetQueryParam("colunaOrdenacao", "o.area")
                                    .SetQueryParam("idTipoAtividade", -1)
                                    .SetQueryParam("filtroStatusApontamento", "null")
                                    .SetQueryParam("filtroStatusProjeto", -1)
                                    .WithCookies(cookies)
                                    .OnRedirect(c =>
                                    {
                                        RemoverCookies();
